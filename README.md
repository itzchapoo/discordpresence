...
# Installation
 ...
 1. Create a new folder named `Discord-Presence` anywhere in your resources folder
 2. Put the script files inside of this folder
 3. Configure the script according to the config file.
 4. Put `ensure Discord-Presence` at the bottom of your server.cfg
